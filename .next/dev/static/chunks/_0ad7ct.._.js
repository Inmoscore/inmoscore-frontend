...
function BuscarPage() {
    ...
    const buscarArrendatario = async (e)=>{
        ...
        setResultado(null);
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3001")}/api/search-tenant?cedula=${cedula}`);
...
_s(BuscarPage, "LRylRrjfk3yNoxHv4L2tlHSe6Bs=");
_c = BuscarPage;
var _c;
...
//# sourceMappingURL=_0ad7ct.._.js.map