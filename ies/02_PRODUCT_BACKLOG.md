...
| TASK-003 | TASK | Confirmar hosting backend productivo | DONE | CRITICAL | EPIC-008 | Railway o alternativa | InmoScore Engineering Team | SPR-004 | Host elegido, healthcheck definido y CORS planificado. | Railway productivo desplegado; build exitoso y `GET /health` validado con `200` el 2026-07-31. |
...
| BUG-003 | Cuentas con correo no confirmado reciben sesion completa y pueden ejecutar operaciones sensibles | DONE | HIGH | EPIC-001 | Supabase Auth, backend, frontend, Resend | InmoScore Engineering Team | SPR-004 | Cuenta pendiente conserva acceso limitado; backend bloquea operaciones sensibles; confirmacion exige nueva sesion; pagos aprobados no activan plan antes de confirmar. | Validacion productiva controlada completada el 2026-07-31: sesion restringida bloqueada, nuevo login `full`, checkout Wompi `200`, plan sin activar y limpieza QA completa. |
...
| 2026-07-31 | BUG-003 y TASK-003 pasan a DONE con evidencia productiva de Railway, `/health`, sesion restringida y checkout Wompi controlado. El incidente `500` del checkout queda resuelto por configuracion de las variables Wompi requeridas en Railway. | InmoScore Engineering Team |
